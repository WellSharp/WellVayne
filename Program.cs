...
namespace hi_im_gosu
{
    public class Vayne
    {
        ...
        public static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu = new Menu("WellVayne Released", "WellVayne Released", true);
            //Orbwalker
            ...
            Game.PrintChat("<font color='#75E011'>Vayne assembly By Theus</font> Loaded.");
            Game.PrintChat(
                "<font color='#0FCDF2'>Voce gostou ?  </font> <font color='#ff1900'>De um Upvote Na Assembly Database </font>");
            Game.PrintChat(
                "<font color='#DA1717'>Donate ===></font> <font color='#BD16EB'>skype balinha.matheus</font>");
            Game.PrintChat(
                 "<font color='#15E3EE'>Creditos ===></font> <font color='#0D7D3A'>Asuna Zezzy Exory Diabaths Well</font>");
            menu.AddToMainMenu();
        }
